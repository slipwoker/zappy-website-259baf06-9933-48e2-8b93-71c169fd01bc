    ...
    contactForm.addEventListener('submit', async function(e) {
      ...
      if (window.zappyContactFormLoaded) {
        try {
          ...
          const zappyPayload = {
            websiteId: '259baf06-9933-48e2-8b93-71c169fd01bc',
            name: name,
            email: email,
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Liat Spa Clinic - ליאת קליניק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
